...
@push('scripts')
    <script src="{{ asset('js/home/home.js?v=2') }}"></script>
@endpush
@push('styles')
    ...
    <div class="my-4 shadow-lg p-3 mb-5 rounded filters">
        ...
        <div class="col-12 col-sm-11">
            <div class="row">
                ...
                <div class=" my-2 col-6 col-sm-2">
                    <img src="https://mapadeobras.seinfra.go.gov.br/assets/landing/img/markers/esporte.png" width="30px">
                    <span>Esporte e Lazer</span>
                </div>
                <div class=" my-2 col-6 col-sm-2">
                    <img src="https://mapadeobras.seinfra.go.gov.br/assets/landing/img/markers/educacao.png" width="30px">
                    <span>Educação</span>
                </div>
                <div class=" my-2 col-6 col-sm-2">
                ...
                <div class=" my-2 col-6 col-sm-2">
                    <img src="https://mapadeobras.seinfra.go.gov.br/assets/landing/img/markers/saude.png" width="30px">
                    <span>Saúde</span>
                </div>
                <div class=" my-2 col-6 col-sm-2">
                    <img src="https://mapadeobras.seinfra.go.gov.br/assets/landing/img/markers/default.png" width="30px">
                    <span>Outras</span>
                </div>
            </div>
        </div>
